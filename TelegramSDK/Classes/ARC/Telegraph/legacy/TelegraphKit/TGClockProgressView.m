...
static UIImage *progressFrameImage()
{
    ...
    if (image == nil)
        image = [UIImage imageNamed:@"ClockFrame.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
static UIImage *progressMinImage()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"ClockMin.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
static UIImage *progressHourImage()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"ClockHour.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}

static UIImage *progressWhiteFrameImage()
{
    return [UIImage imageNamed:@"ClockWhiteFrame.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
}

static UIImage *progressWhiteMinImage()
{
    return [UIImage imageNamed:@"ClockWhiteMin.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
}

static UIImage *progressWhiteHourImage()
{
    return [UIImage imageNamed:@"ClockWhiteHour.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
}
...
- (void)animateHourView
{
    ...
    {
        _hourView.transform = CGAffineTransformRotate(_hourView.transform, M_PI_2);
...
- (void)animateMinView
{
    [UIView animateWithDuration:MINUTE_DURATION delay:0.0f options:UIViewAnimationOptionCurveLinear animations:^
     {
         _minView.transform = CGAffineTransformRotate(_minView.transform, M_PI_2);
     } completion:^(BOOL finished)
     {
         if (finished)
         {
