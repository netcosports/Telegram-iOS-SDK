...
static UIImage *buttonLeftNormal()
{
    ...
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupLeft.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:8 topCapHeight:0];
    return image;
}
...
static UIImage *buttonLeftHighlighted()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupLeft_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:8 topCapHeight:0];
    return image;
}
...
static UIImage *buttonCenterNormal()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupCenter.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
    return image;
}
...
static UIImage *buttonCenterHighlighted()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupCenter_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
    return image;
}
...
static UIImage *buttonRightNormal()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupRight.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
    return image;
}
...
static UIImage *buttonRightHighlighted()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupRight_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
    return image;
}
...
static UIImage *separatorImageNormal()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupDivider.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
static UIImage *separatorImageLeftHighlighted()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupDivider_LeftHighlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
static UIImage *separatorImageRightHighlighted()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"ButtonGroupDivider_RightHighlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
- (void)updateImages
{
    ...
    for (UIButton *button in _buttonList)
    {
        ...
        else if (index == _buttonList.count - 1)
        {
...
- (void)buttonPressed:(UIButton *)button
{
    ...
    for (UIButton *currentButton in _buttonList)
    {
        ...
        if (currentButton == button)
        {
            ...
            if (_delegate != nil)
                [_delegate buttonGroupViewButtonPressed:self index:index];
...
- (void)sizeToFit
{
    ...
    float buttonHeight = _isLandscape ? 25 : 30;
    
    float overallWidth = buttonWidth * _buttonList.count + separatorWidth * MAX(0, _buttonList.count - 1);
...
- (void)layoutSubviews
{
    ...
    float separatorWidth = _buttonSeparatorImage.size.width;
    float buttonHeight = _buttonLeftImage.size.height;
