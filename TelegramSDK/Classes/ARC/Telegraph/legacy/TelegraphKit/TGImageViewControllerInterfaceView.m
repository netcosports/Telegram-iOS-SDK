...
- (id)initWithFrame:(CGRect)frame enableEditing:(bool)enableEditing disableActions:(bool)disableActions
{
    ...
    if (self != nil)
    {
        ...
        UIImage *playImage = [UIImage imageNamed:@"VideoPanelPlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *pauseImage = [UIImage imageNamed:@"VideoPanelPause.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        if (!disableActions)
        {
        	UIImage *actionImage = [UIImage imageNamed:@"ActionsWhiteIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        UIImage *deleteImage = [UIImage imageNamed:@"DeleteWhiteIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
