...
@property (nonatomic) float initialHandlePosition;
@property (nonatomic) float initialHandleTouchPosition;
@property (nonatomic) float onHandlePosition;
...
@synthesize foregroundContainer = _foregroundContainer;
...
@synthesize gestureInProgress = _gestureInProgress;

@synthesize initialHandlePosition = _initialHandlePosition;
@synthesize initialHandleTouchPosition = _initialHandleTouchPosition;
@synthesize onHandlePosition = _onHandlePosition;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _backgroundView.image = [UIImage imageNamed:@"SwitchBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        _foregroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SwitchBlue.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        ...
        _onTextView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SwitchOnText.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        [_textContainer addSubview:_onTextView];
        
        _offTextView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SwitchOffText.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        ...
        _transitionView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SwitchBlueTransition.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        [transitionContainer addSubview:_transitionView];
        
        _shadowView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 77, 27)];
        _shadowView.image = [UIImage imageNamed:@"SwitchShadow.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        [self addSubview:_shadowView];
        
        UIImage *rawMaskImage = [UIImage imageNamed:@"SwitchMask.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        _handleView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SwitchBulb.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] highlightedImage:[UIImage imageNamed:@"SwitchBulb_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)setOn:(bool)on duration:(NSTimeInterval)duration notifyDelegate:(bool)notifyDelegate
{
    ...
    float handlePosition = !on ? -1 : _onHandlePosition;
...
- (void)panGestureRecognized:(UIPanGestureRecognizer *)recognizer
{
    ...
    else if (recognizer.state == UIGestureRecognizerStateChanged)
    {
        ...
        float translation = [recognizer translationInView:self].x + _initialHandlePosition;
