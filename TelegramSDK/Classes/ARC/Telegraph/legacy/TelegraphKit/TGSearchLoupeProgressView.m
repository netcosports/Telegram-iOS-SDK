...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        _frameView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ProgressLoupeFrame.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        [self addSubview:_frameView];
        
        _hourView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ProgressLoupeHour.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        _hourView.frame = CGRectOffset(_hourView.frame, 10.5f, 2.5f);
        [self addSubview:_hourView];
        
        _minView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ProgressLoupeMinute.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
