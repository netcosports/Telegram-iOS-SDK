...
- (void)loadView
{
    ...
    UIImage *imageNormal = [[UIImage imageNamed:@"BackButton_Overlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:15 topCapHeight:0];
    UIImage *imageNormalHighlighted = [[UIImage imageNamed:@"BackButton_Overlay_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:15 topCapHeight:0];
    ...
    UIImage *minimizeImage = [UIImage imageNamed:@"BrowserMinimize.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *minimizeHighlightedImage = [UIImage imageNamed:@"BrowserMinimize_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    UIImageView *shadowView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"BrowserFooterShadow.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    ...
    UIImage *backImage = [UIImage imageNamed:@"BrowserFooterBack.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *backHighlightedImage = [UIImage imageNamed:@"BrowserFooterBack_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    
    UIImage *forwardImage = [UIImage imageNamed:@"BrowserFooterForward.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *forwardHighlightedImage = [UIImage imageNamed:@"BrowserFooterForward_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    
    UIImage *stopImage = [UIImage imageNamed:@"BrowserFooterStop.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *stopHighlightedImage = [UIImage imageNamed:@"BrowserFooterStop_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    
    UIImage *reloadImage = [UIImage imageNamed:@"BrowserFooterRefresh.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *reloadHighlightedImage = [UIImage imageNamed:@"BrowserFooterRefresh_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    
    UIImage *actionImage = [UIImage imageNamed:@"BrowserFooterActions.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *actionHighlightedImage = [UIImage imageNamed:@"BrowserFooterActions_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    
    UIImage *maximizeImage = [UIImage imageNamed:@"BrowserFooterMaximize.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *maximizeHighlightedImage = [UIImage imageNamed:@"BrowserFooterMaximize_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
