...
- (UITextField *)customTextField
{
    if (_customTextField == nil)
    {
        ...
        if (_style == TGSearchBarStyleDefault || _style == TGSearchBarStyleLight || _style == TGSearchBarStyleLightPlain)
        {
            ...
            clearImage = [UIImage imageNamed:@"SearchBarClearIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        }
        else if (_style == TGSearchBarStyleDark)
        {
            textColor = [UIColor whiteColor];
            clearImage = [UIImage imageNamed:@"SearchBarClearIconDark.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        }
...
- (UIView *)customScopeButtonContainer
{
    if (_customScopeButtonContainer == nil)
    {
        ...
        [_customSegmentedControl setBackgroundImage:[UIImage imageNamed:@"ModernSegmentedControlBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
        [_customSegmentedControl setBackgroundImage:[UIImage imageNamed:@"ModernSegmentedControlSelected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateSelected barMetrics:UIBarMetricsDefault];
        [_customSegmentedControl setBackgroundImage:[UIImage imageNamed:@"ModernSegmentedControlSelected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateSelected | UIControlStateHighlighted barMetrics:UIBarMetricsDefault];
        [_customSegmentedControl setBackgroundImage:[UIImage imageNamed:@"ModernSegmentedControlHighlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateHighlighted barMetrics:UIBarMetricsDefault];
        UIImage *dividerImage = [UIImage imageNamed:@"ModernSegmentedControlDivider.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
