...
static UIImage *deliveredCheckmark()
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"ModernConversationListIconDelivered.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
static UIImage *readCheckmark()
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"ModernConversationListIconRead.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (_isEncrypted)
    {
        ...
        if (multichatImage == nil)
            multichatImage = [UIImage imageNamed:@"ModernConversationListIconLock.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    else if (false && _isMultichat)
    {
        ...
        static UIImage *multichatImage = nil;
        if (multichatImage == nil)
            multichatImage = [UIImage imageNamed:@"DialogListGroupChatIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = multichatImage;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier assetsSource:(id<TGDialogListCellAssetsSource>)assetsSource
{
    ...
    if (self)
    {
        ...
        _avatarIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"BroadcastLargeAvatarIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)resetView:(bool)keepState
{
    ...
    if (_deliveryState == TGMessageDeliveryStateFailed)
    {
        ...
        {
            _deliveryErrorBackgrond = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernConversationListBadgeUnsent.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    ...
    if (_outgoing)
    {
        ...
        if (_deliveryState == TGMessageDeliveryStatePending)
        {
            if (_pendingIndicator == nil)
            {
                ...
                if (pendingImage == nil)
                {
                    pendingImage = [UIImage imageNamed:@"DialogListPending.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
                }
    ...
    if (_isMuted)
    {
        if (_muteIcon == nil)
        {
            _muteIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"DialogList_Muted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        }
