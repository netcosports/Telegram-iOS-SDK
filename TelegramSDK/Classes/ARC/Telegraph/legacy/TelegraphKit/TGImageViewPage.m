...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        UIImage *playButtonImage = [UIImage imageNamed:@"PlayButtonBig.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        [_playButton setBackgroundImage:[UIImage imageNamed:@"PlayButtonBig_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateHighlighted];
        ...
        UIImage *normalTrackImage = [UIImage imageNamed:@"VideoSliderBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *disabledTrackImage = [UIImage imageNamed:@"VideoSliderBackground_Disabled.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *trackForegroundImage = [UIImage imageNamed:@"VideoSliderForeground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        [_sliderView setThumbImage:[UIImage imageNamed:@"VideoSliderHandle.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
        [_sliderView setThumbImage:[UIImage imageNamed:@"VideoSliderHandle_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateHighlighted];
