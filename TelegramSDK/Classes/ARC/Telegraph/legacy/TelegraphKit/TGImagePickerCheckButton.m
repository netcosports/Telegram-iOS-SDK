...
static UIImage *checkImageNormal()
{
    ...
    if (image == nil)
        image = [UIImage imageNamed:@"ImagePickerSelect.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
static UIImage *checkImageChecked()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"ImagePickerSelect_Checked.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
static UIImage *smallCheckImageNormal()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"ImagePickerThumbnalSelect.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
static UIImage *smallCheckImageChecked()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"ImagePickerThumbnalSelect_Checked.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
