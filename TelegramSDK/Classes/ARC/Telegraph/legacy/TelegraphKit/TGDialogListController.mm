...
- (UIBarButtonItem *)controllerRightBarButtonItem
{
    ...
    {
        TGModernBarButton *composeButton = [[TGModernBarButton alloc] initWithImage:[UIImage imageNamed:@"ModernNavigationComposeButtonIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
