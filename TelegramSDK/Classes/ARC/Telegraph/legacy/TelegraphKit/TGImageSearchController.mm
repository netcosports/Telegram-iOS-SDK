...
- (void)loadView
{
    ...
    _nothingFoundIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"NothingFoundIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    ...
    UIImageView *darkBackground = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ImagePickerPreviewPanel.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)updateDimmingViewImageStateAnimated:(bool)animated currentUrl:(NSString *)currentUrl pausedState:(int)pausedState
{
    if (_dimmingOverlayViewContentView == nil)
    {
        ...
        UIImage *cancelImage = [UIImage imageNamed:@"ImageDownloadCancel.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *cancelHighlightedImage = [UIImage imageNamed:@"ImageDownloadCancel_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        dispatch_once(&onceToken, ^
        {
            UIImage *rawBackground = [UIImage imageNamed:@"LinearProgressBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
            progressBackgroundImage = [rawBackground stretchableImageWithLeftCapWidth:(int)(rawBackground.size.width / 2) topCapHeight:0];
            UIImage *rawForeground = [UIImage imageNamed:@"LinearProgressForeground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        UIImage *rawOverlayTopButtonImage = [UIImage imageNamed:@"SearchImagesButtonTop.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *rawOverlayTopButtonHighlightedImage = [UIImage imageNamed:@"SearchImagesButtonTop_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *rawOverlayBottomButtonImage = [UIImage imageNamed:@"SearchImagesButtonBottom.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *rawOverlayBottomButtonHighlightedImage = [UIImage imageNamed:@"SearchImagesButtonBottom_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
