...
- (void)commonInit
{
    UIImage *rawLeftImage = [UIImage imageNamed:@"MapCalloutLeft.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *rawLeftHighlightedImage = [UIImage imageNamed:@"MapCalloutLeft_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *rawRightImage = [UIImage imageNamed:@"MapCalloutRight.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *rawRightHighlightedImage = [UIImage imageNamed:@"MapCalloutRight_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    
    UIImage *centerImage = [UIImage imageNamed:@"MapCalloutCenter.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *centerHighlightedImage = [UIImage imageNamed:@"MapCalloutCenter_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    _arrowView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MapCalloutArrow.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
