...
- (void)loadView
{
    ...
    _locationNormalIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MapLocationIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    ...
    _locationActiveIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MapLocationIcon_Active.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    ...
    _locationActiveHeadingIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MapLocationIcon_ActiveHeading.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
