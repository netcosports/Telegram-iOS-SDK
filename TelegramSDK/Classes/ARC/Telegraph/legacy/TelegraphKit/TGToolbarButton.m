...
static UIImage *backgroundBack()
{
    ...
    if (image == nil)
        image = [[UIImage imageNamed:@"BackButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:15 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundBackPressed()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"BackButton_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:15 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundBackLandscape()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"BackButton_Landscape.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:15 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundBackLandscapePressed()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"BackButton_Landscape_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:15 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundGeneric()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"HeaderButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundGenericPressed()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"HeaderButton_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundGenericLandscape()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"HeaderButton_Landscape.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundGenericPressedLandscape()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"HeaderButton_Landscape_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
static UIImage *backgroundDone()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Blue.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
static UIImage *backgroundDonePressed()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Blue_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
static UIImage *backgroundDoneLandscape()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Blue_Landscape.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
static UIImage *backgroundDoneLandscapePressed()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Blue_Landscape_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
static UIImage *backgroundDoneBlack()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Login_Blue.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
static UIImage *backgroundDoneBlackPressed()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Login_Blue_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
static UIImage *backgroundDoneBlackLandscape()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Login_Blue_Landscape.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
static UIImage *backgroundDoneBlackLandscapePressed()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"HeaderButton_Login_Blue_Landscape_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
static UIImage *backgroundDelete()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"Header_Button_Delete.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:6 topCapHeight:0];
    return image;
}
...
- (void)layoutSubviews
{
    ...
    if (!_buttonImageView.hidden && _buttonImageView.image != nil)
    {
        ...
        imageFrame.origin.y = floorf(((bounds.size.height - imageFrame.size.height) / 2) + imageAddY);
    }
    else
    ...
    {
        labelFrame.origin.x = floorf(labelFrame.origin.x);
