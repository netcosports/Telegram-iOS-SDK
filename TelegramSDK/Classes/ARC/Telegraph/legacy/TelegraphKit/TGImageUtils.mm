...
UIImage *TGSecretAttachmentImage(UIImage *source, CGSize sourceSize, CGSize destSize)
{
    ...
    {
        UIImage *rawImage = [UIImage imageNamed:@"ModernMessageImageBorder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
UIImage *TGAttachmentImage(UIImage *source, CGSize sourceSize, CGSize size, __unused bool incoming, bool location)
{
    ...
    dispatch_once(&onceToken, ^
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentPhotoBubble.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    if (location)
    {
        ...
        dispatch_once(&onceToken, ^
        {
            markerImage = [UIImage imageNamed:@"MapThumbnailMarker.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
