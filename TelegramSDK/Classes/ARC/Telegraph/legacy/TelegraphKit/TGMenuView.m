...
@property (nonatomic) float arrowLocation;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _arrowTopView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MenuArrowTop.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] highlightedImage:[UIImage imageNamed:@"MenuArrowTop_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        [self addSubview:_arrowTopView];
        
        _arrowBottomView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MenuArrowBottom.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] highlightedImage:[UIImage imageNamed:@"MenuArrowBottom_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)setButtonsAndActions:(NSArray *)buttonsAndActions watcherHandle:(ASHandle *)watcherHandle
{
    ...
    while (_buttonViews.count > index + 1)
    {
    ...
    while (_separatorViews.count < _buttonViews.count - 1)
    {
        ...
        separatorView.image = [UIImage imageNamed:@"MenuButtonSeparator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    for (TGMenuButtonView *buttonView in _buttonViews)
    {
        ...
        if (index == 0 || index == _buttonViews.count - 1)
        {
...
- (void)menuButtonHighlighted
{
    ...
    {
        separatorNormal = [UIImage imageNamed:@"MenuButtonSeparator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        separatorLeft = [UIImage imageNamed:@"MenuButtonSeparatorLeft.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        separatorRight = [UIImage imageNamed:@"MenuButtonSeparatorRight.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    });
...
{
    UIImage *rawLeftImage = [UIImage imageNamed:@"MenuButtonLeft.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *leftImage = [rawLeftImage stretchableImageWithLeftCapWidth:(int)(rawLeftImage.size.width - 1) topCapHeight:0];
    UIImage *rightImage = [[UIImage imageNamed:@"MenuButtonRight.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:0 topCapHeight:0];
    UIImage *rawCenterImage = [UIImage imageNamed:@"MenuButtonCenter.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *centerImage = [rawCenterImage stretchableImageWithLeftCapWidth:(int)(rawCenterImage.size.width / 2) topCapHeight:0];
    
    UIImage *rawLeftHighlightedImage = [UIImage imageNamed:@"MenuButtonLeft_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    UIImage *rightHighlightedImage = [[UIImage imageNamed:@"MenuButtonRight_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:0 topCapHeight:0];
    UIImage *rawCenterHighlightedImage = [UIImage imageNamed:@"MenuButtonCenter_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (void)showInView:(UIView *)view fromRect:(CGRect)rect
{
    ...
    if (frame.origin.y < 2)
    {
        ...
        {
            frame.origin.y = floorf((view.frame.size.height - frame.size.height) / 2);
            _arrowOnTop = false;
        }
        else
            _arrowOnTop = true;
...
- (void)layoutSubviews
{
    ...
    for (TGMenuButtonView *buttonView in _buttonViews)
    {
        ...
        float lineWidth = buttonView.frame.size.width;
        ...
        if (containsArrow)
        {
            float minArrowX = buttonView.frame.origin.x + (index == 0 ? 10 : 0);
            float maxArrowX = buttonView.frame.origin.x + buttonView.frame.size.width - _arrowTopView.frame.size.width + (index == _buttonViews.count - 1 ? (-10) : 0);

            float arrowX = floorf(_arrowLocation - _arrowTopView.frame.size.width / 2);
...
- (void)buttonPressed:(TGMenuButtonView *)buttonView
{
    ...
    for (TGMenuButtonView *listButtonView in _buttonViews)
    {
        ...
        if (listButtonView == buttonView)
        {
            ...
            if (index < _buttonDescriptions.count)
            {
