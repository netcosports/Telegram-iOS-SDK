...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        if (selectedCellImage == nil)
            selectedCellImage = [[UIImage imageNamed:@"CellHighlighted96.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:0 topCapHeight:1];
        ...
        UIImageView *disclosureIndicator = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"MenuDisclosureIndicator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
