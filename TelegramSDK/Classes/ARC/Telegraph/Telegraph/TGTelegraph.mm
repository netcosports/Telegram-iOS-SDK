...
- (id)init
{
    ...
    if (self != nil)
    {
        ...
        [TGRemoteImageView registerImageProcessor:^UIImage *(UIImage *source)
        {
            return TGScaleAndRoundCornersWithOffset(source, CGSizeMake(69, 69), CGPointMake(1, 0.5f), CGSizeMake(71, 71), 9, [UIImage imageNamed:@"LoginProfilePhotoOverlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil], false, nil);
        } withName:@"signupProfileAvatar"];
        
        [TGRemoteImageView registerImageProcessor:^UIImage *(UIImage *source)
        {
            UIImage *rawImage = [UIImage imageNamed:@"LoginBigPhotoOverlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (void)registerTimeout:(TGAFHTTPRequestOperation *)operation duration:(NSTimeInterval)duration
{
    [ActionStageInstance() dispatchOnStageQueue:^
    {
...
- (void)removeTimeout:(TGAFHTTPRequestOperation *)operation
{
    [ActionStageInstance() dispatchOnStageQueue:^
    {
...
{
    TGAFHTTPRequestOperation *operation = timer.userInfo;
...
- (void)enqueueRawHttpRequest:(TGRawHttpRequest *)request
{
    ...
    TGAFHTTPRequestOperation *httpOperation = [[TGAFHTTPRequestOperation alloc] initWithRequest:urlRequest];
    ...
    [httpOperation setCompletionBlockWithSuccess:^(TGAFHTTPRequestOperation *operation, __unused id responseObject)
    {
    ...
    } failure:^(__unused TGAFHTTPRequestOperation *operation, NSError *error)
    {
...
- (NSObject *)doRequestRawHttpFile:(NSString *)url actor:(id<TGRawHttpFileActor>)__unused actor
{
    ...
    [httpOperation setCompletionBlockWithSuccess:^(__unused TGAFHTTPRequestOperation *operation, __unused id responseObject)
    {
...
- (id)doCheckUpdates:(TGCheckUpdatesActor *)actor
{
    ...
    NSString *versionString = [[NSString alloc] initWithFormat:@"%@ (%@)", [[mainBundle() infoDictionary] objectForKey:@"CFBundleShortVersionString"], [[mainBundle() infoDictionary] objectForKey:@"CFBundleVersion"]];
