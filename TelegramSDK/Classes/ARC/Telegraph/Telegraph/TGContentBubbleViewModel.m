...
- (instancetype)initWithMessage:(TGMessage *)message author:(TGUser *)author context:(TGModernViewContext *)context
{
    ...
    if (self != nil)
    {
        ...
        {
            _broadcastIconModel = [[TGModernImageViewModel alloc] initWithImage:[UIImage imageNamed:@"ModernMessageBroadcastIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
