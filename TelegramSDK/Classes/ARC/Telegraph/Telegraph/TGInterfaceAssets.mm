...
- (UIColor *)blueLinenBackground
{
    ...
    dispatch_once(&onceToken, ^
    {
        color = [UIColor colorWithPatternImage:[UIImage imageNamed:@"Linen.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    });
    return color;
}
...
- (UIColor *)darkLinenBackground
{
    ...
    dispatch_once(&onceToken, ^
    {
        color = [UIColor colorWithPatternImage:[UIImage imageNamed:@"DarkLinen.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    });
    return color;
}
...
- (UIColor *)linesBackground
{
    ...
    dispatch_once(&onceToken, ^
    {
        color = [UIColor colorWithPatternImage:[UIImage imageNamed:@"SettingsBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    });
    return color;
}
...
- (UIColor *)footerBackground
{
    ...
    dispatch_once(&onceToken, ^
    {
        color = [UIColor colorWithPatternImage:[UIImage imageNamed:@"Footer.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
    });
    return color;
}
...
- (UIImage *)dialogListSearchIcon
{
    ...
    if (image == nil)
        image = [UIImage imageNamed:@"SearchBarIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)dialogListSearchCancelButton
{
    ...
    if (image == nil)
    {
        UIImage *tile = [UIImage imageNamed:@"SearchCancelButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (UIImage *)dialogListSearchCancelButtonHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *tile = [UIImage imageNamed:@"SearchCancelButton_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [tile stretchableImageWithLeftCapWidth:(int)(tile.size.width / 2) topCapHeight:(int)(tile.size.height / 2)];
    }
    return image;
}
...
- (UIImage *)dialogListGroupChatIcon
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"DialogListGroupChatIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)dialogListGroupChatIconHighlighted
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"DialogListGroupChatIcon_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)dialogListUnreadCountBadge
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"DialogListUnreadBadge.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (UIImage *)dialogListUnreadCountBadgeHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"DialogListUnreadBadge_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)((rawImage.size.width) / 2) topCapHeight:(int)((rawImage.size.height) / 2)];
    }
    return image;
}
...
- (UIImage *)dialogListDeliveryErrorBadge
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"DialogErrorBadge.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)dialogListDeliveryErrorBadgeHighlighted
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"DialogErrorBadge_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)avatarPlaceholder:(int)uid
{
    ...
    if (uid == 333000)
        return [UIImage imageNamed:@"DialogListAvatarSystem.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (UIImage *)avatarPlaceholderGeneric
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"DialogListAvatarPlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)authorAvatarPlaceholder
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"DialogListAuthorAvatarPlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)smallAvatarPlaceholder:(int)uid
{
    ...
    if (uid == 333000)
        return [UIImage imageNamed:@"SmallAvatarSystem.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (UIImage *)smallAvatarPlaceholderGeneric
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"DialogListAvatarPlaceholderSmall.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)avatarMask
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"AvatarMask.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)avatarMaskUnread
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"AvatarMaskUnread.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)avatarMaskHighlighted
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"AvatarMaskHighlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)avatarMask40
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"AvatarMask40.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)avatarMask40Highlighted
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"AvatarMask40_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)callButton
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"Call_Button.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:16 topCapHeight:15];
    return image;
}
...
- (UIImage *)callButtonHighlighted
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"Call_Button_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:16 topCapHeight:15];
    return image;
}
...
- (UIImage *)callButtonPhone
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"Phone.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)callButtonPhoneHighlighted
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"Phone_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)timelineHeaderShadow
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"Profile_Shadow.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;    
}
...
- (UIImage *)dialogListAuthorAvatarStroke
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"DialogListAvatarStroke.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)profileAvatarPlaceholder:(int)uid
{
    ...
    if (uid == 333000)
        return [UIImage imageNamed:@"ProfileAvatarSystem.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
+ (UIImage *)profileAvatarPlaceholderGeneric
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"ProfilePhotoPlaceholderGeneric.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)actionButton
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"Actions_Button.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:20 topCapHeight:22];
    return image;
}
...
+ (UIImage *)actionButtonHighlighted
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"Actions_Button_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:20 topCapHeight:22];
    return image;
}
...
+ (UIImage *)timelineLocationIcon
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"TimelineLocation.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)timelineImagePlaceholder
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"TimelineImagePlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:2 topCapHeight:2];
    return image;
}
...
+ (NSArray *)timelineImageCorners
{
    ...
    if (array == nil)
    {
        array = [[NSArray alloc] initWithObjects:[UIImage imageNamed:@"TimelineImageCornerTL.png" inBundle:mainBundle() compatibleWithTraitCollection:nil], [UIImage imageNamed:@"TimelineImageCornerTR.png" inBundle:mainBundle() compatibleWithTraitCollection:nil], [UIImage imageNamed:@"TimelineImageCornerBL.png" inBundle:mainBundle() compatibleWithTraitCollection:nil], [UIImage imageNamed:@"TimelineImageCornerBR.png" inBundle:mainBundle() compatibleWithTraitCollection:nil], nil];
    }
    return array;
}
...
+ (UIImage *)memberListAvatarOverlay
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MembersAvatarOverlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)conversationGenericAvatarPlaceholder:(bool)useMonochrome
{
    if (useMonochrome)
    {
        static UIImage *image = nil;
        if (image == nil)
            image = [UIImage imageNamed:@"ConversationAvatarPlaceholder_Mono.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        return image;
    }
    else
    {
        static UIImage *image = nil;
        if (image == nil)
            image = [UIImage imageNamed:@"ConversationAvatarPlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        return image;
    }
...
+ (UIImage *)conversationAvatarOverlay
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MultichatAvatarOverlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)timelineDeletePhotoButton
{
    ...
    dispatch_once(&onceToken, ^
    {
        image = [[UIImage imageNamed:@"DeletePhoto.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:13 topCapHeight:12];
    });
    return image;
}
...
+ (UIImage *)timelineDeletePhotoButtonHighlighted
{
    ...
    dispatch_once(&onceToken, ^
    {
        image = [[UIImage imageNamed:@"DeletePhoto_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:13 topCapHeight:12];
    });
    return image;
}
...
+ (UIImage *)timelineActionPhotoButton
{
    ...
    dispatch_once(&onceToken, ^
    {
        image = [[UIImage imageNamed:@"ActionPhoto.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:13 topCapHeight:13];
    });
    return image;
}
...
+ (UIImage *)timelineActionPhotoButtonHighlighted
{
    ...
    dispatch_once(&onceToken, ^
    {
        image = [[UIImage imageNamed:@"ActionPhoto_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:13 topCapHeight:13];
    });
    return image;
}
...
+ (UIImage *)groupedCellTopHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"GroupedCellTop_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
+ (UIImage *)groupedCellMiddleHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"GroupedCellMiddle_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        if ([rawImage respondsToSelector:@selector(resizableImageWithCapInsets:resizingMode:)])
            image = [rawImage resizableImageWithCapInsets:UIEdgeInsetsMake(5, 13, 6, rawImage.size.width - 13 - 1) resizingMode:UIImageResizingModeStretch];
        else
            image = [rawImage stretchableImageWithLeftCapWidth:(int)((rawImage.size.width / 2)) topCapHeight:(int)(rawImage.size.height - 2)];
...
+ (UIImage *)groupedCellBottomHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"GroupedCellBottom_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
+ (UIImage *)groupedCellSingleHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"GroupedCellSingle_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        if ([rawImage respondsToSelector:@selector(resizableImageWithCapInsets:resizingMode:)])
            image = [rawImage resizableImageWithCapInsets:UIEdgeInsetsMake(5, 13, 6, rawImage.size.width - 13 - 1) resizingMode:UIImageResizingModeStretch];
        else
            image = [rawImage stretchableImageWithLeftCapWidth:(int)((rawImage.size.width / 2)) topCapHeight:(int)((rawImage.size.height / 2))];
...
+ (UIImage *)groupedCellDisclosureArrow
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MenuDisclosureIndicator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)groupedCellDisclosureArrowHighlighted
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MenuDisclosureIndicator_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)mediaGridImagePlaceholder
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"FlatImagePlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
+ (UIImage *)notificationBackground
{
    ...
    dispatch_once(&onceToken, ^
    {
        UIImage *rawImage = [UIImage imageNamed:@"BannerBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)((rawImage.size.width) / 2) topCapHeight:(int)((rawImage.size.height) / 2)];
    });
    return image;
}
...
+ (UIImage *)notificationAvatarOverlay
{
    ...
    dispatch_once(&onceToken, ^
    {
        image = [UIImage imageNamed:@"BannerAvatarOverlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    });
    return image;
}
...
+ (UIImage *)notificationAvatarPlaceholderGeneric
{
    ...
    dispatch_once(&onceToken, ^
    {
        image = [UIImage imageNamed:@"BannerAvatarPlaceholderGeneric.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    });
    return image;
}
...
{
    return [UIImage imageNamed:@"BannerLocationIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
}
...
- (UIImage *)conversationUserPhotoOverlay
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"ConversationUserPhotoOverlay.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:(int)(rawImage.size.height / 2)];
    }
    return image;
}
