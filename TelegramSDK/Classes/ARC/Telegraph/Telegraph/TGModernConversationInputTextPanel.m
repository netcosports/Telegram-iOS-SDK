...
- (instancetype)initWithFrame:(CGRect)frame accessoryView:(UIView *)panelAccessoryView
{
    ...
    if (self)
    {
        ...
        {
            fieldBackgroundImage = [[UIImage imageNamed:@"ModernConversationInput.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:8 topCapHeight:8];
            attachImage = [UIImage imageNamed:@"ModernConversationAttach.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        });
        ...
        _micButtonIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernConversationMicButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)setShowRecordingInterface:(bool)show velocity:(CGFloat)velocity
{
    ...
    if (show)
    {
        ...
        _micButtonIconView.image = [UIImage imageNamed:@"ModernConversationMicButton_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        if (_slideToCancelLabel == nil)
        {
            ...
            _slideToCancelArrow = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernConversationAudioSlideToCancel.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
            CGRect slideToCancelArrowFrame = viewFrame(_slideToCancelArrow);
    ...
    else
    {
        ...
        _micButtonIconView.image = [UIImage imageNamed:@"ModernConversationMicButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
