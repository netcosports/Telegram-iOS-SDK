...
- (void)loadView
{
    ...
    [_linkButton setBackgroundImage:[UIImage imageNamed:@"Transparent.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    UIImage *rawLinkImage = [UIImage imageNamed:@"LinkFull.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
