...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (iosMajorVersion() < 7)
    {
        ...
        UIImage *backImage = [UIImage imageNamed:@"NavigationBackButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *backHighlightedImage = [UIImage imageNamed:@"NavigationBackButton_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *backLandscapeImage = [UIImage imageNamed:@"NavigationBackButtonLandscape.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *backLandscapeHighlightedImage = [UIImage imageNamed:@"NavigationBackButtonLandscape_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    //_addContactsController.tabBarItem.image = [UIImage imageNamed:@"Tabbar_Add.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    dispatch_after(popTime, dispatch_get_main_queue(), ^
    {
        ...
        if ([[mainBundle() bundleIdentifier] isEqualToString:@"org.telegram.TelegramEnterprise"])
            appId = @"3ad4b94adc8b2ccddcea172a1cfc0af2";
        else if ([[mainBundle() bundleIdentifier] isEqualToString:@"org.telegram.TelegramHD"])
            appId = @"9b35ab047aa742d7604372d155da96f6";
        else
            appId = @"af86b54bbc799bd3e6d570ae30035037";
#else
        if ([[mainBundle() bundleIdentifier] isEqualToString:@"org.telegram.TelegramHD"])
...
- (void)loadSettings
{
    ...
    else
    {
        ...
        NSString *filePath = [mainBundle() pathForResource:imageUrl ofType:@"jpg"];
...
- (void)playSound:(NSString *)name vibrate:(bool)vibrate
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        if (name != nil && TGAppDelegateInstance.soundEnabled)
        {
            ...
            if (soundId == nil)
            {
                NSString *path = [NSString stringWithFormat:@"%@/%@", [mainBundle() resourcePath], name];
...
- (void)playNotificationSound:(NSString *)name
{
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        NSError *error = nil;
        AVAudioPlayer *audioPlayer = [[AVAudioPlayer alloc] initWithContentsOfURL:[mainBundle() URLForResource:name withExtension: @"m4a"] error:&error];
        if (error == nil)
        {
