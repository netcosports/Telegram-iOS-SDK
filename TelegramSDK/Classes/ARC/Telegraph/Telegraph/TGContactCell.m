...
static UIImage *contactCellCheckImage()
{
    ...
    if (image == nil)
        image = [UIImage imageNamed:@"ModernContactSelectionEmpty.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
static UIImage *contactCellCheckedImage()
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"ModernContactSelectionChecked.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
