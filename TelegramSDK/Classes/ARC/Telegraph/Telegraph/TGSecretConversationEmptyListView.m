...
{
    UIImageView *iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernConversationEmptyListLockIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
