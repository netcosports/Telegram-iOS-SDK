...
static UIImage *tokenBackgroundImage()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"TokenBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
static UIImage *tokenBackgroundHighlightedImage()
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"TokenBackground_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
