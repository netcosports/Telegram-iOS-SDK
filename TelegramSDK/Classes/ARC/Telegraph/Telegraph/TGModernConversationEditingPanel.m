...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        UIImage *deleteImage = [UIImage imageNamed:@"ModernConversationActionDelete.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *deleteDisabledImage = [UIImage imageNamed:@"ModernConversationActionDelete_Disabled.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *forwardImage = [UIImage imageNamed:@"ModernConversationActionForward.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        UIImage *forwardDisabledImage = [UIImage imageNamed:@"ModernConversationActionForward_Disabled.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
