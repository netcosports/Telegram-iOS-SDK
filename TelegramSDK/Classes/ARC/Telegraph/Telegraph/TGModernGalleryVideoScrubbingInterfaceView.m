...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        UIImage *scrubberBackgroundImageRaw = [UIImage imageNamed:@"VideoSliderBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        UIImage *scrubberForegroundImageRaw = [UIImage imageNamed:@"VideoSliderForeground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        ...
        _scrubberHandle = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"VideoSliderHandle.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
