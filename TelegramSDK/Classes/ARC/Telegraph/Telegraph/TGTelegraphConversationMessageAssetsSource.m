...
{
    return [UIImage imageNamed:@"InlineAvatarPlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
}
...
{
    return [UIImage imageNamed:@"MessageInlineVideoIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
}
...
- (UIImage *)messageChecked
{
    ...
    if (image == nil)
        image = [UIImage imageNamed:@"MessagesChecked.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)messageUnchecked
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MessagesUnchecked.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)messageEditingSeparator
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MessagesEditingSeparator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)messageBackgroundBubbleIncomingSingle
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"Msg_In.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:20 topCapHeight:15];
    return image;
}
...
- (UIImage *)messageBackgroundBubbleIncomingDouble
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_In_High.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (UIImage *)messageBackgroundBubbleIncomingHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_In_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (UIImage *)messageBackgroundBubbleIncomingHighlightedShadow
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_In_Selected_Shadow.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:20 topCapHeight:15];
    }
    return image;
}
...
- (UIImage *)messageBackgroundBubbleIncomingDoubleHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_In_High_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        if ([rawImage respondsToSelector:@selector(resizableImageWithCapInsets:resizingMode:)])
        {
            image = [rawImage resizableImageWithCapInsets:UIEdgeInsetsMake(15, 23, 15, rawImage.size.width - 23 - 1) resizingMode:UIImageResizingModeStretch];
        }
...
- (UIImage *)messageBackgroundBubbleOutgoingSingle
{
    ...
    if (image == nil)
    {
        image = [[UIImage imageNamed:@"Msg_Out.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:15 topCapHeight:15];
    }
    return image;
}
...
- (UIImage *)messageBackgroundBubbleOutgoingDouble
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_Out_High.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        if ([rawImage respondsToSelector:@selector(resizableImageWithCapInsets:resizingMode:)])
        {
...
- (UIImage *)messageBackgroundBubbleOutgoingHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_Out_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        //if ([rawImage respondsToSelector:@selector(resizableImageWithCapInsets:resizingMode:)])
...
- (UIImage *)messageBackgroundBubbleOutgoingHighlightedShadow
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_Out_Selected_Shadow.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:15 topCapHeight:15];
    }
    return image;
}
...
- (UIImage *)messageBackgroundBubbleOutgoingDoubleHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"Msg_Out_High_Selected.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        if ([rawImage respondsToSelector:@selector(resizableImageWithCapInsets:resizingMode:)])
        {
            image = [rawImage resizableImageWithCapInsets:UIEdgeInsetsMake(15, 17, 15, rawImage.size.width - 17 - 1) resizingMode:UIImageResizingModeStretch];
        }
...
- (UIImage *)messageDateBadgeOutgoing
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"MessageTimestampBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageDateBadgeIncoming
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"MessageTimestampBackgroundIncoming.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageDocumentLabelBackground
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"DocumentLabelBg.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:8 topCapHeight:1];
    return image;
}
...
- (UIImage *)messageForwardedStripe
{
    static UIImage *image = nil;
    if (image == nil)
        image = [[UIImage imageNamed:@"AttachedMessageBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] stretchableImageWithLeftCapWidth:10 topCapHeight:5];
    return image;
}
...
- (UIImage *)messageCheckmarkFullIcon
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MessageCheckFull.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)messageCheckmarkHalfIcon
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MessageCheckHalf.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)messageNotSentIcon
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"NotSent.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)messageLinkFull
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"LinkFull.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (UIImage *)messageLinkCornerTB
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"LinkCornerTB.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)messageLinkCornerBT
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"LinkCornerBT.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)messageLinkCornerLR
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"LinkCornerLR.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)messageLinkCornerRL
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"LinkCornerRL.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImagePlaceholderOutgoing
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentPhotoBubblePlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:(int)(rawImage.size.height / 2)];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImageIncomingTopCorners
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentCornersIncomingTop.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImageIncomingTopCornersHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentCornersIncomingTop_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImageIncomingBottomCorners
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentCornersIncomingBottom.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImageIncomingBottomCornersHighlighted
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentCornersIncomingBottom_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImageOutgoingTopCorners
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentCornersOutgoingTop.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImageOutgoingBottomCorners
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"AttachmentCornersOutgoingBottom.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
    }
    return image;
}
...
- (UIImage *)messageAttachmentImageLoadingIcon
{
    static UIImage *image = nil;
    if (image == nil)
        image = [UIImage imageNamed:@"MediaInlineDownloadingIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    return image;
}
...
- (UIImage *)messageActionConversationPhotoPlaceholder
{
    if (_monochromeColor != -1)
    {
        ...
        if (image == nil)
        {
            UIImage *rawImage = [UIImage imageNamed:@"ProfilePhotoPlaceholder_Mono.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
            image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:0];
        }
        return image;
    }
...
- (UIImage *)membersListAddImage
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"ConversationAddMember.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)membersListAddImageHighlighted
{
    ...
    if (image == nil)
    {
        image = [UIImage imageNamed:@"ConversationAddMember_Pressed.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    return image;
}
...
- (UIImage *)membersListEditTitleBackground
{
    ...
    if (image == nil)
    {
        UIImage *rawImage = [UIImage imageNamed:@"ConversationEditTitle.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        image = [rawImage stretchableImageWithLeftCapWidth:(int)(rawImage.size.width / 2) topCapHeight:(int)(rawImage.size.height / 2)];
    }
    return image;
}
...
- (UIImage *)membersListAvatarPlaceholder
{
    ...
    if (image == nil)
    {
        image = TGScaleAndRoundCornersWithOffset([UIImage imageNamed:@"AvatarPlaceholderSmall.png" inBundle:mainBundle() compatibleWithTraitCollection:nil], CGSizeMake(40, 40), CGPointMake(2, 2), CGSizeMake(44, 44), 4, [TGInterfaceAssets memberListAvatarOverlay], false, nil);
    }
    return image;
}
...
{
    return [UIImage imageNamed:@"ConversationUserPhotoPlaceholder.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
}
