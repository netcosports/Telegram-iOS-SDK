...
{
    UIImageView *backgroundImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernConversationUnreadSeparator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        dispatch_once(&onceToken, ^
        {
            backgroundImage = [UIImage imageNamed:@"ModernConversationUnreadSeparator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        });
