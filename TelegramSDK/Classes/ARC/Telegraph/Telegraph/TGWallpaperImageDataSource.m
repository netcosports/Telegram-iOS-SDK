...
{
    NSString *filePath = [mainBundle() pathForResource:[[NSString alloc] initWithFormat:@"%@builtin-wallpaper-%d%@", [[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad ? @"pad-" : @"", wallpaperId, sizeVariant == nil ? @"" : [[NSString alloc] initWithFormat:@"-%@", sizeVariant]] ofType:@"jpg"];
