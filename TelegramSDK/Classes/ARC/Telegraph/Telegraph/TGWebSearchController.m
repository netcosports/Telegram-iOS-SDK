...
- (UIView *)nothingFoundView
{
    if (_nothingFoundView == nil)
    {
        ...
        UIImageView *nothingFoundIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"NothingFoundIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)loadView
{
    ...
    _toolbarLogoView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"GiphyToolbarLogo.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
