...
- (void)loadInitialState
{
    ...
    [self _setAvatarConversationId:_conversationId title:nil icon:[UIImage imageNamed:@"BroadcastAvatarIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
