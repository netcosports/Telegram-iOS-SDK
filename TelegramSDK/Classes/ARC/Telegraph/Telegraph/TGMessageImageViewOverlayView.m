...
- (void)drawInContext:(CGContextRef)context
{
    ...
    switch (_type)
    {
        ...
        case TGMessageImageViewOverlayViewTypeSecretViewed:
        {
            ...
            {
                fireIconMask = [UIImage imageNamed:@"SecretPhotoFireMask.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
                fireIcon = [UIImage imageNamed:@"SecretPhotoFire.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
                viewedIconMask = [UIImage imageNamed:@"SecretPhotoCheckMask.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
                viewedIcon = [UIImage imageNamed:@"SecretPhotoCheck.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
            });
