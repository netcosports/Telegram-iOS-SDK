...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        UIImageView *iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernConversationEmptyListLogo.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
