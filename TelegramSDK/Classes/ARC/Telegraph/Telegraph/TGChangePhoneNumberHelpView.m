...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        _iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ChangePhoneHelpIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        ...
        UIImageView *arrowView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernTourButtonRightArrow.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
