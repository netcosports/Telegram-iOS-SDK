...
- (void)setHideCheckIndicator:(bool)hide
{
    ...
    else
    {
        if (_checkIndicator == nil)
        {
            _checkIndicator = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ListCheck.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] highlightedImage:[UIImage imageNamed:@"ListCheck_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
