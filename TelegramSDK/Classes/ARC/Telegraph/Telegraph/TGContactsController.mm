...
- (UIBarButtonItem *)controllerRightBarButtonItem
{
    if ((_contactsMode & TGContactsModeMainContacts) == TGContactsModeMainContacts)
    {
        ...
        if (_addButtonItem == nil)
        {
            ...
            {
                TGModernBarButton *addButton = [[TGModernBarButton alloc] initWithImage:[UIImage imageNamed:@"ModernNavigationAddButtonIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
