...
- (instancetype)initWithMessage:(TGMessage *)message contact:(TGUser *)contact author:(TGUser *)author context:(TGModernViewContext *)context
{
    ...
    if (self != nil)
    {
        ...
        dispatch_once(&onceToken1, ^
        {
            ...
            actionImageIncoming = [UIImage imageNamed:@"ModernMessageContactAdd_Incoming.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
            actionImageOutgoing = [UIImage imageNamed:@"ModernMessageContactAdd_Outgoing.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        });
        ...
        if (!_incoming)
        {
            ...
            {
                checkPartialImage = [UIImage imageNamed:@"ModernMessageCheckmark2.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
                checkCompleteImage = [UIImage imageNamed:@"ModernMessageCheckmark1.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
            });
