...
- (void)setButtons:(NSArray *)buttons
{
    ...
    for (NSDictionary *button in _buttons)
    {
        ...
        {
            UIImage *rawButtonImage = [UIImage imageNamed:@"GroupedActionButtonGreen.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
            UIImage *rawButtonHighlightedImage = [UIImage imageNamed:@"GroupedActionButtonGreen_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
{
    UIImage *rawButtonImage = [UIImage imageNamed:@"GroupedActionButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *rawButtonHighlightedImage = [UIImage imageNamed:@"GroupedActionButton_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
