...
- (void)setMode:(TGFlatActionCellMode)mode
{
    ...
    else if (mode == TGFlatActionCellModeCreateBroadcast)
        _titleLabel.text = TGLocalized(@"Compose.NewBroadcastButton");
    ...
    if (inviteIcon == nil)
    {
        inviteIcon = [UIImage imageNamed:@"ModernContactListInviteFriendsIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        friendsIcon = [UIImage imageNamed:@"ModernContactListCreateGroupIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        encryptedIcon = [UIImage imageNamed:@"ModernContactListCreateSecretChatIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        broadcastsIcon = [UIImage imageNamed:@"ModernContactListBroadcastIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    }
    ...
    else if (mode == TGFlatActionCellModeBroadcasts || mode == TGFlatActionCellModeCreateBroadcast)
    {
