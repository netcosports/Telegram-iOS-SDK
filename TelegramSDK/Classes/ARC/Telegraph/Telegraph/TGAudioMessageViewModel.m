...
static UIImage *cancelImageWithColor(UIColor *color, bool incoming)
{
    ...
    UIImage *crossImage = incoming ? [UIImage imageNamed:@"ModernMessageAudioCancel_Incoming.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] : [UIImage imageNamed:@"ModernMessageAudioCancel_Outgoing.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
