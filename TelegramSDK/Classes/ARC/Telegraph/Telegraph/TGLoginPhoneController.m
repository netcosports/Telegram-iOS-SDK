...
- (void)loadView
{
    ...
    UIImage *rawCountryImage = [UIImage imageNamed:@"ModernAuthCountryButton.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    UIImage *rawCountryImageHighlighted = [UIImage imageNamed:@"ModernAuthCountryButtonHighlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
    ...
    UIImage *rawInputImage = [UIImage imageNamed:@"ModernAuthPhoneBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
