...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _disclosureIndicator = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernListsDisclosureIndicator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)layoutSubviews
{
    ...
    for (int i = 0; i < imageCount && i < (int)_wallpaperInfos.count; i++)
    {
        ...
        if (i >= (int)_imageViews.count)
        {
            ...
            UIImageView *checkView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernWallpaperSelectedIndicator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
