...
+ (UIImage *)buttonImage:(bool)checked
{
    if (checked)
    {
        ...
        {
            image = [UIImage imageNamed:@"ModernMessageSelectionChecked.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        });
        return image;
    }
    else
    {
        ...
        dispatch_once(&onceToken, ^
        {
            image = [UIImage imageNamed:@"ModernMessageSelectionUnchecked.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
        });
        return image;
    }
}
