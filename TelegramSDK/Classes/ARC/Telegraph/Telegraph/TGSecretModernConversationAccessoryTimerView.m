...
- (id)init
{
    ...
    if (self)
    {
        ...
        _timerIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ModernConversationSecretAccessoryTimer.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
