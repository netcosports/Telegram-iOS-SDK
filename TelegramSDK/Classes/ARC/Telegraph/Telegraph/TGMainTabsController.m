...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        UIImageView *contactsIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"TabIconContacts.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] highlightedImage:[UIImage imageNamed:@"TabIconContacts_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        [self addSubview:contactsIcon];
        [_buttonViews addObject:contactsIcon];
        
        UIImageView *messagesIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"TabIconMessages.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] highlightedImage:[UIImage imageNamed:@"TabIconMessages_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
        [self addSubview:messagesIcon];
        [_buttonViews addObject:messagesIcon];
        
        UIImageView *settingsIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"TabIconSettings.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] highlightedImage:[UIImage imageNamed:@"TabIconSettings_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
