...
- (void)updateEmptyState:(bool)animated
{
    if (_list.count == 0)
    {
        if (_emptyContainer == nil)
        {
            ...
            UIImageView *iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"EmptyBroadcastListsIcon.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
