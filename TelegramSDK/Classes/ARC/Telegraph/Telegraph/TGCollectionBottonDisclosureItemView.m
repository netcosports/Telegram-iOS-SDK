...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _disclosureIndicator = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ListsDownDisclosureIndicator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
...
- (void)setExpanded:(bool)expanded
{
    ...
    _disclosureIndicator.image = _expanded ? [UIImage imageNamed:@"ListsDownDisclosureIndicator_Highlighted.png" inBundle:mainBundle() compatibleWithTraitCollection:nil] : [UIImage imageNamed:@"ListsDownDisclosureIndicator.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
