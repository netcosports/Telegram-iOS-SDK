...
- (void)loadView
{
    ...
    UIImage *rawImage = [UIImage imageNamed:@"ProgressWindowBackground.png" inBundle:mainBundle() compatibleWithTraitCollection:nil];
...
- (void)dismissWithSuccess
{
    ...
    UIImageView *checkView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ProgressWindowCheck.png" inBundle:mainBundle() compatibleWithTraitCollection:nil]];
